<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"C:\web\blog_tp\public/../application/admin\view\index\index.html";i:1509612200;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
    ...
    <div class="topbar-inner clearfix">
        ...
        <div class="top-info-wrap">
            <ul class="top-info-list clearfix">
                <li><a class="one" href="http://www.jscss.me">管理员</a></li>
                <li><a class="two" href="http://www.jscss.me">修改密码</a></li>
                <li><a class="three" href="http://www.jscss.me">退出</a></li>
            </ul>
        </div>
    </div>
</div>
    ...
    <div class="sidebar-wrap">
        ...
        <div class="sidebar-content">
            <ul class="sidebar-list">
                <li>
                    <a href="design"><i class="icon-font">&#xe003;</i>常用操作</a>
                    <ul class="sub-menu">
                        <li><a href="design"><i class="icon-font">&#xe008;</i>作品管理</a></li>
                        <li><a href="design"><i class="icon-font">&#xe005;</i>博文管理</a></li>
                        <li><a href="design"><i class="icon-font">&#xe006;</i>分类管理</a></li>
                        <li><a href="design"><i class="icon-font">&#xe004;</i>留言管理</a></li>
                        <li><a href="design"><i class="icon-font">&#xe012;</i>评论管理</a></li>
                        <li><a href="design"><i class="icon-font">&#xe052;</i>友情链接</a></li>
                        <li><a href="design"><i class="icon-font">&#xe033;</i>广告管理</a></li>
                    </ul>
                </li>
                <li>
                    <a href="system"><i class="icon-font">&#xe018;</i>系统管理</a>
                    <ul class="sub-menu">
